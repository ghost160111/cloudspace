...
class Fancybox extends Component<FancyboxProps> {
    ...
    containerRef: RefObject<HTMLDivElement | null> = createRef();
    ...
    setupMutationObserver = debounce(() => {
        const fancyboxContainerNode: HTMLElement | null = document.querySelector(".fancybox__container");
        if (!fancyboxContainerNode) return;
    ...
    mutationObserverCallback = debounce((mutations: MutationRecord[]): void => {
        ...
        for (const mutation of mutations) {
            ...
            const selectedFancyboxSlideNode: HTMLElement | null = target.querySelector(".fancybox__slide.is-selected");
